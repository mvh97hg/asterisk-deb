% asterisk(SECTION) | User Commands
%
% "December 23 2025"
...
asterisk - program to do something

# SYNOPSIS

**asterisk** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**asterisk** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **asterisk** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**asterisk** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    asterisk. See **foo.conf**(5) for further details.
...
**asterisk** provides some return codes, that can be used in scripts:
